...
class KalmanRegression(OnlineRegression):
    ...
    def __init__(self, ts1, ts2, delta=1e-5, maxlen=3000):
        ...
        (state_means, state_covs, _, _) = self.kf.batch_filter(ts1.values, Hs=obs_mat)
...
class CointegrationTest(OnlineRegression):
    ...
    def is_cointegrated(self, significance_level=0.05):
        ...
        return self.adf_pvalues[-1] < significance_level